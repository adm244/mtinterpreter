...
{ PARSER }
procedure ReadSymbol( var input : Text; var symbol : Char; var line : Integer ); inline;
begin
  Read(input, symbol);
  if (symbol = #10) then line := line + 1;
end; {#ReadSymbol}

procedure ReadStateNumber( var input : Text; var expresion : String; var line : Integer ); inline;
var
  symbol : Char;
begin
  expresion := '';
...
procedure EvaluateStateNumber( const expresion : String; var forstate : Integer; line : Integer ); inline;
var
  errcode : Word;
begin
...
begin
  ...
  while true do begin
    ...
    {TODO(adm244): a better way to search through list of commands?}
